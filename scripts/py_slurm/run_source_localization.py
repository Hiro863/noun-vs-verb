...
if __name__ == "__main__":
    ...
    source_localize(dst_dir=epochs_dir, subject=subj_name, epochs=epochs, params=params["stc params"], n_jobs=n_cores)

    write_json(dir_path=epochs_dir / "stc", file_name="parameters.json", data=params["stc params"])
    logging.debug(f"Source localization for {subj_name} has finished")
